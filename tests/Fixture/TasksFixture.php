...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => 'active', 'collate' => 'utf8_general_ci', 'comment' => 'active, maintenance, inactive', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-10-18 16:55:50',
                'modified' => '2019-10-18 16:55:50',
